...
- [ ] Проверить интерполяцию: насколько `movement.progress` отражает реальный прогресс внутри шага (зависит от MovementSystem)
- [ ] Проверить синхронизацию: нет ли визуальных артефактов при 10 ticks/sec симуляции + 60fps рендеринге
- [ ] Проверить производительность при 10+ дронах одновременно
- [ ] Доработать следы и glow если они выглядят некорректно при реальном движении
