...
import { playMenuMissionClick, playMenuStart } from "../audio/menuSounds.js";
  ...
  return (
    ...
    >
      <button
        ...
        onMouseLeave={(e) => {
          (e.currentTarget as HTMLButtonElement).style.color = "#4a8aaa";
        }}
        title="Настройки"
      >
        ⚙
      ...
      >
        {missions.map((mission, index) => (
          <div
            ...
            style={{
              ...CARD,
              borderColor: selected === index ? "#00d4ff" : "#1e3a5f",
            }}
            onClick={() => {
              playMenuMissionClick();
              setSelected(index);
            }}
          >
            <div
