...
В обычной сессии достаточно читать **PROGRESS.md** и **SESSION.md**.
...
- Обновлять [PROGRESS.md](PROGRESS.md) при завершении каждой задачи или фазы — отмечать чекбоксы и менять статус в таблице.
- В конце каждой сессии добавлять запись в [SESSION.md](SESSION.md): цель, результаты, следующий шаг.
